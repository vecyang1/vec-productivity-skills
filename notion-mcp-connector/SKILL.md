...
description: Use when you need to read, search, edit, or automate workflows in a Notion workspace through MCP or the Direct API.
---
...
- **Source:** canonical public package `vecyang1/vec-productivity-skills/notion-mcp-connector`
- **Author:** Vec + contributors
- **Created:** 2026-03-05
- **Updated:** 2026-08-09
...
- **`references/databases.md`** — Safe public registry template and private-local registry convention
