...
2. Create the directory `.gemini/antigravity/skills/{slug}/`
3. Save each file to the appropriate location:
   - `SKILL.md` → `.gemini/antigravity/skills/{slug}/SKILL.md`
   - Other files → `.gemini/antigravity/skills/{slug}/{filename}`
